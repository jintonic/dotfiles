...
TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR=${TMUX_POWERLINE_DEFAULT_FOREGROUND_COLOR:-'135'}
...
if [ -z $TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS ]; then
	TMUX_POWERLINE_RIGHT_STATUS_SEGMENTS=(
		...
		#"xkb_layout 125 117" \
		#"date_day 6 255" \
		#"date 6 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
		#"time 6 255 ${TMUX_POWERLINE_SEPARATOR_LEFT_THIN}" \
