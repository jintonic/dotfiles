...
# macos_notification_count.sh {
	...
	# sqlite3 -list "/var/folders/3q/v8fp1hjx17jcr2dnp_d2x010fzd1tr/0//com.apple.notificationcenter/db/db" 'select * from app_info'
...
# mailcount.sh {
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILDIR_INBOX="/Users/jing.liu/.mail/inbox/new"
	...
	export TMUX_POWERLINE_SEG_MAILCOUNT_MAILCHECKRC="/Users/jing.liu/.mailcheckrc"
# }
